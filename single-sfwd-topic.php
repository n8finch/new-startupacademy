...
add_filter( 'genesis_comment_list_args', 'start_html5_comment_filter', 20 );
	...
	<section class="slanted-section background-light" >
		<div class="slanted-section-r-l-inner background-light" >
			<div class="skew-inner">
				...
				<aside>
					<?php
					genesis_widget_area( 'sidebar-activities', array(
									'before' => '<div class="learndash-sidebar sidebar-activities">',
									'after' => '</div>',
								) );
					?>
				</aside>
